...
<div class="h-screen relative overflow-hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 px-4">
        <h1 class="text-light text-3xl font-bold text-center font-andada" data-aos="fade-up">{{ $title }}</h1>
    </div>

    <div class="absolute bottom-6 md:bottom-12 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
        <p class="text-light text-[16px] md:text-[20px] tracking-wider mb-[15px] md:mb-[20px]" data-aos="fade-down" data-aos-delay="1500">{{ __('messages.scroll') }}</p>
