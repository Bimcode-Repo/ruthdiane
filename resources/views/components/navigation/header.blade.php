<div class="absolute top-0 left-0 right-0 h-[80px] md:h-[115px] border-b border-light z-20 flex items-center justify-between px-4 md:px-16">
    <a href="/" class="flex items-center gap-2 md:gap-4 hover:opacity-80 transition-opacity">
        ...
        <div class="text-left">
            <h3 class="text-light text-[14px] md:text-[20px] font-semibold leading-none font-andada">Ruth Safdie Interiors</h3>
            <p class="text-light text-[8px] md:text-[10px] leading-none font-joan">Unlock The Art Of Refined Interiors</p>
        </div>
    </a>
