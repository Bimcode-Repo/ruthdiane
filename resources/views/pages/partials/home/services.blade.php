    ...
    <div class="max-w-8xl mx-auto px-[20px] md:px-[40px]">
        <div class="flex flex-col md:flex-row justify-between mb-8 md:mb-16 gap-6">
            <div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                <h1 class="text-[40px] md:text-[60px] text-white font-bold leading-none font-andada">{{ __('messages.our_services') }}</h1>
            ...
            <div class="flex items-end md:pb-2">
                <a href="/contact" class="flex items-center gap-3 text-[#C4A882] hover:opacity-80 transition-opacity group">
                    <span class="text-[18px] md:text-[25px] leading-none font-andada">{{ __('messages.contact_us') }}</span>
        ...
        <div class="flex flex-col lg:flex-row gap-0 mb-8 md:mb-12 bg-background-darker">
            ...
            <div class="flex flex-col justify-center py-[20px] px-[20px] md:py-[25px] md:px-[40px] md:h-[400px] flex-1">
                <h2 class="text-[28px] md:text-4xl text-white font-semibold mb-[30px] md:mb-[60px] font-andada">{{ __('messages.lorem_short') }}</h2>
                <p class="text-white text-[18px] md:text-[22px] leading-relaxed mb-[30px] md:mb-[60px] font-joan">
        ...
        <div class="mt-8 md:mt-12">
            <div class="bg-[#C4A882] py-8 md:py-16 px-6 md:px-8 flex flex-col lg:flex-row justify-between items-center gap-6 md:gap-8">
                <div>
                    <h2 class="text-3xl md:text-5xl text-[#3D3935] font-light mb-2 font-andada">{{ __('messages.lorem_banner_title') }}</h2>
