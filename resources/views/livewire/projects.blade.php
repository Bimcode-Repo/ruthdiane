...
<div class="h-screen relative overflow-hidden">
    ...
    <div class="absolute top-[130px] left-16 z-20 hidden md:block">
        <nav class="flex items-center gap-[60px] text-light text-[22px]" style="font-family: 'Andada Pro', serif;">
            ...
            <a href="/projects" class="relative hover:text-primary transition-colors duration-300">
                <!-- Trait vertical centré sur la bordure du header au niveau de Projects -->
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 px-4">
        <h1 class="text-light text-[40px] md:text-[60px] font-bold text-center" style="font-family: 'Andada Pro', serif;">{{ __('messages.projects') }}</h1>
    </div>
    ...
    <div class="max-w-8xl mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-baseline gap-8 md:gap-12 mb-8 md:mb-16">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                <h1 class="text-[40px] md:text-6xl lg:text-7xl text-white font-light">{{ __('messages.all_projects') }}</h1>
        ...
        <div x-ref="slider" @scroll="updateArrows()" class="flex gap-4 md:gap-6 overflow-x-hidden scroll-smooth relative">
            ...
            <a href="/projet/lorem" class="relative group overflow-hidden w-[280px] md:w-[530px] h-[195px] md:h-[369px] flex-shrink-0 block">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-4 md:p-8 transition-opacity duration-300" :class="isCardPartial(0) ? 'opacity-50' : 'opacity-100'">
                    <h2 class="text-white text-[16px] md:text-[20px] mb-[10px] md:mb-[15px]" style="font-family: 'Andada Pro', serif; font-weight: 600;">{{ __('messages.project_name') }}</h2>
