...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('projects', function (Blueprint $table) {
            $table->dropColumn([
                'section1_title_fr', 'section1_title_en', 'section1_title_es', 'section1_title_it',
                'section1_description_fr', 'section1_description_en', 'section1_description_es', 'section1_description_it',
                'section2_title_fr', 'section2_title_en', 'section2_title_es', 'section2_title_it',
                'section2_description_fr', 'section2_description_en', 'section2_description_es', 'section2_description_it',
            ]);
        });
    }
};
